        ...
        <div className="relative border-2 border-[#003eb3] px-8 rounded-xl">
          <Row className="flex items-center justify-center h-full">
            <Col lg={4}>
              ...
              <h4 className="float-right clear-both font-bold">Chức vụ: </h4>
            </Col>
            <Col lg={2} />
            <Col lg={6} className="">
              <h4 className="float-left clear-both">{"ming"}</h4>
              <h4 className="float-left clear-both">{"sexgay@gmail.com"}</h4>
              <h4 className="float-left clear-both">{"Địa chỉ"}</h4>
              <h4 className="float-left clear-both">{"Đĩ"}</h4>
            </Col>
          </Row>
        </div>
      </Row>
      <button style={{ margin: "5px" }}>Sửa</button>
    </div>
  );
};
